...
var SYSTEM_PROMPT_TO_KOREAN =
  ...
  'GLOSSARY: \u0e17\u0e19\u0e32\u0e22/\u0e17\u0e19\u0e32\u0e22\u0e04\u0e27\u0e32\u0e21=\ubcc0\ud638\uc0ac(NOT \ud310\uc0ac), \u0e1c\u0e39\u0e49\u0e1e\u0e34\u0e1e\u0e32\u0e01\u0e29\u0e32=\ud310\uc0ac, \u0e28\u0e32\u0e25=\ubc95\uc6d0, \u0e27\u0e35\u0e0b\u0e48\u0e32=\ube44\uc790, \u0e1a\u0e23\u0e34\u0e29\u0e31\u0e17=\ud68c\uc0ac, \u0e25\u0e39\u0e01\u0e04\u0e49\u0e32=\uace0\uac1d, \u0e04\u0e48\u0e32\u0e18\u0e23\u0e23\u0e21\u0e40\u0e19\u0e35\u0e22\u0e21=\uc218\uc218\ub8cc, \u0e22\u0e01\u0e40\u0e25\u0e34\u0e01=\ucde8\uc18c, ช่วงนี้/ตอนนี้=요즘, วันนี้=오늘, ภายหลัง/ทีหลัง=나중에, เร็วๆนี้=최근, นิติบุคคล=법인, บริษัทจำกัด=법인회사, สัญญา=계약, เอกสาร=서류, ยื่นคำร้อง=신청, ยืนยัน/ตรวจสอบ=확인, ดำเนินการ=진행, จัดการ=처리, ผู้รับผิดชอบ=담당자, โอนเงิน=입금/송금, บัญชีธนาคาร=계좌, ใบเสร็จ=영수증, ใบเสนอราคา=견적, เงินมัดจำ=계약금, ยอดคงเหลือ=잔금, ภาษี=세금, ใบอนุญาต=허가, จดทะเบียน=등록, หนังสือเดินทาง=여권, พำนัก=체류, ต่ออายุ=연장, หมดอายุ=만료, ตรวจคนเข้าเมือง=출입국, ชาวต่างชาติ=외국인, สอบถาม=문의, สัปดาห์นี้=이번 주, สัปดาห์หน้า=다음 주, สัปดาห์ที่แล้ว=지난주, ยัง=아직, เรียบร้อยแล้ว=이미, ตรวจสอบ/สอบสวน=조사, ถือหุ้น/เจ้าของ=소유';
